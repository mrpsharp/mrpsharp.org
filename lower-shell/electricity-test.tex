...
\begin{questions}
    ...
    \question[3] How many electrons would need to flow between two points each second in order to produce a current of 2 amps? (NB: The charge on an electron is  1.6 x 10$^{-19}$ coulombs.) \and{2cm}
